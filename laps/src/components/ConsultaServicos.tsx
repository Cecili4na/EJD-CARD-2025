                        ...
                        <div className="space-y-8">
                            <div className="flex justify-between items-center">
                                ...
                                >
                                    ...
                                    {mostrarUltimoDono ? 'Ocultar Dados do Proprietário' : 'Mostrar Dados do Proprietário'}
                                </button>
                            </div>
                            ...
                            {mostrarUltimoDono && (
                                <div className="bg-blue-50 rounded-xl p-6 border border-blue-100 shadow">
                                    <h3 className="text-xl font-bold text-blue-900 mb-4">Dados do Proprietário</h3>
