...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE schemaname = 'public'
          AND tablename = 'sapatinho_products'
          AND policyname = 'Users can view sapatinho products'
    ) THEN
        CREATE POLICY "Users can view sapatinho products"
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE schemaname = 'public'
          AND tablename = 'sapatinho_products'
          AND policyname = 'Users can manage sapatinho products'
    ) THEN
        CREATE POLICY "Users can manage sapatinho products"
        ON public.sapatinho_products
        FOR ALL
        USING (true);
    END IF;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE schemaname = 'public'
          AND tablename = 'sapatinho_sales'
          AND policyname = 'Users can view sapatinho sales'
    ) THEN
        CREATE POLICY "Users can view sapatinho sales"
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE schemaname = 'public'
          AND tablename = 'sapatinho_sales'
          AND policyname = 'Users can insert sapatinho sales'
    ) THEN
        CREATE POLICY "Users can insert sapatinho sales"
        ON public.sapatinho_sales
        FOR INSERT
        WITH CHECK (true);
    END IF;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE schemaname = 'public'
          AND tablename = 'sapatinho_sale_items'
          AND policyname = 'Users can view sapatinho sale items'
    ) THEN
        CREATE POLICY "Users can view sapatinho sale items"
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE schemaname = 'public'
          AND tablename = 'sapatinho_sale_items'
          AND policyname = 'Users can insert sapatinho sale items'
    ) THEN
        CREATE POLICY "Users can insert sapatinho sale items"
        ON public.sapatinho_sale_items
        FOR INSERT
        WITH CHECK (true);
    END IF;
