  ...
  return (
    <div className="space-y-6">
      ...
      <Header 
        ...
        subtitle={product ? 'Atualize as informações do produto' : 'Cadastre um novo produto mágico'}
        showLogo={false}
        showBackButton={true}
        onBack={onCancel}
      />
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={4}
              className="w-full px-4 py-3 border-2 border-emerald-200 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-colors duration-200 bg-white/90 resize-none"
