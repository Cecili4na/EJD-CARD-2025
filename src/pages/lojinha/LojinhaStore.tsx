...
type LojinhaScreen = 'list' | 'create' | 'edit' | 'view' | 'sales'

const LojinhaStore: React.FC<LojinhaStoreProps> = ({ 
  products, 
  onCreateProduct, 
  onEditProduct, 
  onDeleteProduct,
  ...
  const [currentScreen, setCurrentScreen] = useState<LojinhaScreen>('list')
  ...
  switch (currentScreen) {
    ...
    case 'sales':
      return <LojinhaSales onBack={() => setCurrentScreen('list')} products={products} />
    default:
      break
  }
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <Header 
        title="🏪 Lojinha Mágica"
        subtitle="Gerencie produtos e vendas da sua lojinha"
        showLogo={false}
      ...
      <ProductList 
        ...
        title="🛍️ Produtos da Lojinha"
        subtitle="Gerencie os produtos da sua lojinha mágica"
      />
    </div>
  )
}

// Componente de vendas da lojinha
const LojinhaSales: React.FC<{ onBack: () => void; products: Product[] }> = ({ onBack, products }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Header 
        title="🛒 Vendas da Lojinha"
        subtitle="Processe vendas dos produtos da lojinha"
        showLogo={false}
        showBackButton={true}
        onBack={onBack}
      />
            ...
            <div className="space-y-3">
              ...
              <div className="border-t pt-4">
                ...
                <Button
                  onClick={processSale}
                  size="lg"
                  className="w-full bg-yellow-500 hover:bg-yellow-600 text-black shadow-lg hover:shadow-yellow-200"
