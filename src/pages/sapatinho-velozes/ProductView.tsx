      ...
      <Card className="bg-gradient-to-br from-white to-gray-50 border-gray-200">
        <div className="space-y-6">
          ...
          <div className="flex justify-between items-start">
            <span className="px-4 py-2 bg-ruby-100 text-ruby-800 rounded-full text-lg font-semibold">
              {product.category}
            </span>
          ...
          <div>
            ...
            <div className="w-20 h-1 bg-ruby-500 rounded-full"></div>
          </div>

          {/* Preço */}
          <div className="bg-gradient-to-r from-ruby-100 to-ruby-200 rounded-xl p-6">
            <p className="text-ruby-700 text-sm mb-2">Preço de Venda</p>
